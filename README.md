...
Drop it into any folder. Run one installer and get a complete toolchain (REQUIRED 1GB+):

- **Neovim (stable/nightly)** [Link](https://github.com/neovim/neovim "Give me a starr :P")
